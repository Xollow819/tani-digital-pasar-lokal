        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-4xl mx-auto">
            <p className="text-lg mb-6">
              Tani Digital bermula dari keprihatinan terhadap kondisi petani Indonesia yang sering kesulitan mengakses pasar yang lebih luas dan mendapatkan harga yang layak untuk produk mereka. Banyak petani yang terjebak dalam rantai distribusi panjang, sehingga keuntungan yang mereka terima tidak sebanding dengan kerja keras mereka.
            </p>
            <p className="text-lg mb-6">
              Pada tahun 2023, sekelompok anak muda yang peduli dengan masa depan pertanian Indonesia mulai mengembangkan platform yang dapat menghubungkan petani langsung dengan konsumen. Melalui riset mendalam dan kolaborasi dengan berbagai komunitas petani, Tani Digital resmi diluncurkan pada April 2024.
            </p>
            <p className="text-lg mb-6">
              Selain marketplace, kami juga fokus pada aspek edukasi karena kami percaya bahwa pengetahuan adalah kunci kemajuan. Melalui video tutorial, petani dapat mempelajari teknik pertanian modern, manajemen usaha tani, dan pemasaran digital yang akan membantu mereka meningkatkan kualitas dan nilai produk.
            </p>
            <p className="text-lg mb-6">
              Saat ini, Tani Digital telah menghubungkan lebih dari 1.000 petani dengan ribuan konsumen di seluruh Indonesia. Kami terus berkembang dan berinovasi untuk menciptakan ekosistem pertanian digital yang berkelanjutan dan menguntungkan bagi semua pihak.
            </p>
